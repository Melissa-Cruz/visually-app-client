        ...
        <main className="main-add-moment-container">
            ...
            <div>
                ...
                <form className="moment-form">
                    ...
                    <div>
                        <label htmlFor="timeline_description"> Why do you want to pursue this vision?:</label>
                        <textarea type="textarea" name="timeline_description" id="timeline"></textarea>
                    </div>  

                    <div>
                        <label htmlFor="timeline_start_date">Timeline start date:  </label>
                        <input type="date" name="timeline_start_date" id="timeline_start_date"/>
                    </div>  
                    ...
                    <div className="main-action-form-div-submit-container">
                        <input className="main-action-form-div-input" type="submit" value="Save"/>
                    </div>
