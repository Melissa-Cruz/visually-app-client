    ...
    <main>
      ...
      <form className="main-action-form">
        <div>
          <input
            type="radio"
            id="action_upload_progress"
            name="action_type"
            value="ActionUploadProgress"
          />
        ...
        <div>
          <input
            type="radio"
            id="action_modify_timeline"
            name="action_type"
            value="ActionModifyTimeline"
          />
        ...
        <div>
          <input
            type="radio"
            id="action_create_timeline"
            name="action_type"
            value="ActionCreateTimeline"
          />
