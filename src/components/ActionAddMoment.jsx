        ...
        <div>
            ...
            <form className="moment-form">
                ...
                <div>
                    ...
                    <textarea type="textarea" name="moment_description" id="moment_description"></textarea>
                </div>  

                <div>
                    <label htmlFor="moment_status"> Status:</label>
                    <select name="moment_status"
                    id="moment_status">
                ...
                <div>
                    ...
                    <input type="text" name="moment_milestones" id="moment_milestones"/>
                </div>  

                <div>
                    <label htmlFor="moment_date"> Date of moment:</label>
                    <input type="date" name="moment_milestones" id="moment_milestones"/>
                </div>  

                <div className="main-action-form-div-submit-container"><input className="main-action-form-div-input" type="submit" value="Save"/>
                </div>
